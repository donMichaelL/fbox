...
public class SOSInsertObservationDavisSmall {
	...
	public SOSInsertObservationDavisSmall (String filePosition) {
		this.owner = null;
		this.unigueID = null;
		this.longitude = null;
		this.latitude = null;
	...
	/**
	 * {VALUE_3} (For "rainRate" PHENOMENON)
	 */
	//Method for setting the value of the {VALUE_3} tag (for "rainRate" the value can only be double)
	public void setRainRateValue (double value) {
		this.rainRateValue = Double.toString(value);
	}
	
	//Method for getting the value of the {VALUE_3} tag (for "rainRate" the value can only be double)
	...
	private boolean validateFields () {
		...
		if(this.rainRateValue == null) {
			validation = false;
			System.err.println("[ERROR] Value for the field \"VALUE_3\" (for rainRate PHENOMENON) hasn't been set!");
		}
	...
	public String createXML () {
		...
		if(this.validateFields() == false)
			...
			xmlToChangeString = xmlToChangeString.replaceAll("\\{VALUE_3\\}",this.rainRateValue);
