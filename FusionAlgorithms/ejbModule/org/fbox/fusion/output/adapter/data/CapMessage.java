...
public class CapMessage {
	...
	public CapMessage(String identifier, String msgType, String sender,
			...
			String areaDesc, String circle, String polygon) {
	...
	public String toXML() {
		...
		if(circle != null) {
			//System.out.println("Generate a circle!!");
			area.addCircle(this.circle);
		}
		
		if(polygon != null) {
			//System.out.println("Generate a polygon!!");
			area.addPolygon(this.polygon);
		}
	...
	public String toString() {
		return "CapMessage [identifier=" + identifier + ", msgType=" + msgType
				+ ", sender=" + sender + ", scope=" + scope + ", sent=" + sent
				+ ", status=" + status + ", source=" + source + ", addresses="
				+ addresses + ", category=" + category + ", certainty="
				+ certainty + ", description=" + description + ", event="
				+ event + ", headline=" + headline + ", language=" + language
				+ ", senderName=" + senderName + ", severity=" + severity
				+ ", urgency=" + urgency + ", areaDesc=" + areaDesc
