...
@XmlRootElement(name = "validateRM")
public class ValidateRM {

    @XmlElementRef(name = "RM", namespace = "http://webservice.edxlinbound.ies", type = JAXBElement.class, required = false)
